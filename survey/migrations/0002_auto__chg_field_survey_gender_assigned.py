...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Survey.gender_assigned'
        db.alter_column(u'survey_survey', 'gender_assigned', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Survey.gender_assigned'
        db.alter_column(u'survey_survey', 'gender_assigned', self.gf('django.db.models.fields.CharField')(max_length=2))
